...
router.get("/inicio", async function (request: Request, response: Response, next: NextFunction) {
	response.send("hola llego...!");
});
/**
 * @description:
 */
router.get("/sign-in", async function (request: Request, response: Response, next: NextFunction) {
 ...
 * @description:
 */
router.post("/sign-up", async function (request: Request, response: Response, next: NextFunction) {
